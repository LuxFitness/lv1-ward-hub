...
import { moveInsRouter } from './routes/moveIns';
...
// Move-ins and upcoming ordinances — require auth
app.use('/api/move-ins', requireAuth, moveInsRouter);
app.use('/api/upcoming', requireAuth, upcomingRouter);
